...
const cardVariants = cva(
  "rounded-lg border bg-card text-card-foreground shadow-[var(--shadow-card)] transition-[var(--transition-smooth)]",
  {
    variants: {
      variant: {
        default: "",
        hover: "hover:shadow-[var(--shadow-card-hover)] hover:bg-card-hover cursor-pointer",
